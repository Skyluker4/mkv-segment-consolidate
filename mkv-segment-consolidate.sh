...
#
# As a special designation under Section 14 of the GNU Affero General Public
# License, Luke Andrew Simmons is a proxy who can decide which future versions
# of the GNU Affero General Public License can be used for this software.
#
